public class  HashcodeEx{
	public static void main(String[] args){
		...
		System.out.println("str과 str2의 주소값은 같나요 ? :" +
							(str==str2));
		...
		System.out.println("test1과 test2의 주소값은 같나요 ? :" +
							(test1==test2));
		
		System.out.println("test1과 test2의 해시코드값은 같나요 ? :" +
							(test1.hashCode()==test2.hashCode()));
		
		System.out.println("test1의 해시코드값은 ? :" +(test1.hashCode()));
		System.out.println("test2의 해시코드값은 ? :" +(test2.hashCode()));
